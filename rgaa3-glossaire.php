...
$lang = 'fr';
$pageTitle = 'Glossaire - RGAA 3.0 2017 - Tanaguru';
$pageDescription = 'Glossaire du RGAA 3 2017, mis en page par Tanaguru. Toutes les définitions pour bien comprendre les critères.';
$canonicalUrl = '/rgaa3-glossaire.html';
$alternateUrls = array (
...
<main id="main" role="main">
			<div class="headrub page">
				<h1>Glossaire du RGAA 3 2017</h1>
				<p class="lead">Le référentiel RGAA (Référentiel Général d'Accessibilité pour les Administrations) fait référence à de nouveaux termes, de nouvelles définitions. À&nbsp;l'occasion de la parution officielle du référentiel RGAA, la liste des nouvelles définitions sera mise à jour si&nbsp;nécessaire et intégrée au glossaire RGAA.</p>
				<div id="navtoc">
			...
			<div class="page">
				<h2 id="a">A</h2>
				<ul class="skiplink">
					<li class="goafter"><a href="#b">Lettre&nbsp;B</a></li>
				</ul>

				<h3 id="acceder-collection-de-pages">Accéder à chaque page de la collection de pages</h3>
				...
				<h3 id="accessible-clavier-souris">Accessible et activable par le clavier et la souris</h3>
				<ul>
				...
				<p>Message d’alerte interrompant la navigation ou l’utilisation de la page, notamment en demandant de cliquer sur un bouton ou un lien pour continuer la navigation ou l’utilisation du contenu. Par exemple, une boîte de dialogue générée par JavaScript <i>via</i> la fonction <code lang="en">alert</code>. Par extension, une fenêtre modale (contenu présenté sous forme de "fenêtre" insérée ou affichée dans le DOM) qui nécessite d’être fermée pour continuer la navigation ou l’utilisation du contenu est considérée comme une alerte. Note&nbsp;: la désactivation des alertes concernées peut être proposée avant le déclenchement de l’alerte, par exemple, <i>via</i> un paramètre utilisateur ou lors de l’affichage de la première alerte, par exemple <i>via</i> une case à cocher "ne plus afficher cette alerte".</p>

				<h3 id="alternative-script">Alternative (à script)</h3>
				<p>Texte ou procédé associé au script <i>via</i> une technique appropriée et permettant de mettre à disposition une fonction ou un contenu similaire à celui proposé par script.</p>
				...
				<h3 id="audiodescription-etendue">Audio-description étendue</h3>
				<p>Audio-description ajoutée à une présentation audiovisuelle en mettant en pause la vidéo de manière à avoir le temps d’ajouter des descriptions supplémentaires. <strong>Note</strong>&nbsp;: cette technique est à utiliser seulement si le sens de la vidéo est perdu sans audio-description supplémentaire et que les pauses entre les dialogues ou la narration sont trop courtes.</p>

				<h3 id="audiodescription-synchronisee">Audio-description synchronisée (média temporel)</h3>
				<p>Narration ajoutée (<i>via</i> un fichier son) à une piste sonore pour décrire les détails visuels importants qui ne peuvent être compris à partir de la piste sonore principale seulement. L’audio-description doit être synchronisée avec le média temporel grâce à l’utilisation de format spécialisés comme le format SRT par exemple.</p>
				<ul>
					<li><strong>Note 1</strong>&nbsp;: l’audio-description d’une vidéo fournit de l’information à propos des actions, des personnages, des changements de scènes, du texte apparaissant à l’écran et d’autres contenus visuels.</li>
					<li><strong>Note 2</strong>&nbsp;: dans une audio-description standard, la narration est ajoutée durant les pauses qui existent dans le dialogue. (Voir aussi audio-description étendue.)</li>
					<li><strong>Note 3</strong>&nbsp;: lorsque toute l’information de la vidéo est déjà donnée dans la piste audio, aucune audio-description supplémentaire n’est requise.</li>
				</ul>

				<h2 id="b">B</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#a">Lettre&nbsp;A</a></li>
					<li class="goafter"><a href="#c">Lettre&nbsp;C</a></li>
				</ul>
				...
				<h3 id="bloc-dinformations-de-meme-nature">Bloc d’informations de même nature</h3>
				...
				<h2 id="c">C</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#b">Lettre&nbsp;B</a></li>
					<li class="goafter"><a href="#d">Lettre&nbsp;D</a></li>
				</ul>
				...
				<h3 id="champ-de-saisie">Champ de saisie de formulaire</h3>
				...
				<h3 id="compatible-technologies-assistance">Compatible avec les technologies d’assistance</h3>
				<p>Un contenu ou une fonctionnalité doit être compatible avec les technologies d’assistance des utilisateurs ainsi qu’avec les fonctions d’accessibilité des navigateurs et des autres agents utilisateurs <i>via</i> une API d’accessibilité.</p>
				...
				<h3 id="comprehensible">Compréhensible (ordre de lecture)</h3>
				...
				<h3 id="composants">Composant d'interface</h3>
				...
				<p><strong>Note</strong>&nbsp;: la pratique qui consiste à gérer des images en propriété de fond d’éléments <i>via</i> CSS est formellement déconseillée, même si elle est accompagnée d’un texte caché.</p>

				<h3 id="contexte-lien">Contexte du lien</h3>
				...
				<ul>
					<li>Si RsRGB &gt;= 0,03928 alors R = RsRGB/12,92 sinon R = ((RsRGB+0,055)/1,055) ^ 2,4&nbsp;;</li>
					<li>Si GsRGB &gt;= 0,03928 alors G = GsRGB/12,92 sinon G = ((GsRGB+0,055)/1,055) ^ 2,4&nbsp;;</li>
					<li>Si BsRGB &gt;= 0,03928 alors B = BsRGB/12.92 sinon B = ((BsRGB+0,055)/1,055) ^ 2,4&nbsp;;</li>
				</ul>
				<p>et RsRGB, GsRGB et BsRGB sont définis par&nbsp;:</p>
				<ul>
				...
				<p>Tous les contenus en mouvement, à l’exception des média temporels pris en charge par la thématique multimédia, sont concernés&nbsp;: les images animés (par exemple un gif animé), les contenus en mouvement proposés <i>via</i> une balise <code lang="en">object</code>, du code <code lang="en">JavaScript</code> ou des effets <code lang="en">CSS</code> par exemple.</p>
				...
				<p><strong>Note 2&nbsp;:</strong> la méthode de contrôle du contenu en mouvement ou clignotant doit permettre à l’utilisateur d’interagir avec le reste de la page. En conséquence, l’arrêt ou la mise en pause <i>via</i> un événement déclenché uniquement sur la prise de focus ne permet pas de valider le critère.</p>
				<p><strong>Note 2&nbsp;:</strong> Dans certains cas, le mouvement fait partie intégrante du composant et il n’est pas possible d’en donner le contrôle à l’utilsateur, par exemple une barre de progression dont la fonction est d’indiquer par un mouvement la progression d’un évènement comme un téléchargement. Dans ce cas le critère est Non Applicable.</p>
				...
				<h3 id="controle-consultation">Contrôle de la consultation (d’un média temporel)</h3>
				...
				<ul>
				  ...
				  <ul>
					...
					<li>Chaque fonctionnalité doit être accessible par le clavier, <i>via</i> la touche de tabulation, et par la souris au moins&nbsp;;</li>
				...
				<h3 id="controle-de-saisie-formulaire">Contrôle de saisie (formulaire)</h3>
				...
				<h2 id="d">D</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#c">Lettre&nbsp;C</a></li>
					<li class="goafter"><a href="#e">Lettre&nbsp;E</a></li>
				</ul>

				<h3 id="description-detaillee-image">Description détaillée (image)</h3>
				<p>Contenu associé à une image en complément de son alternative textuelle afin de décrire en totalité l’information véhiculée par l’image. La description détaillée peut être insérée <i>via</i>&nbsp;:</p>
				<ul>
				...
				<h2 id="e">E</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#d">Lettre&nbsp;D</a></li>
					<li class="goafter"><a href="#f">Lettre&nbsp;F</a></li>
				</ul>
				...
				<h3 id="entete-de-colonne-ou-de-ligne">En-tête de colonne ou de ligne</h3>
				...
				<h3 id="environnement-maitrise">Environnement maîtrisé</h3>
				...
				<h3 id="etiquette">Étiquette de champ de formulaire</h3>
				...
				<h3 id="etiquettes-coherentes">Étiquettes cohérentes</h3>
				...
				<h2 id="i">I</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#f">Lettre&nbsp;F</a></li>
					<li class="goafter"><a href="#j">Lettre&nbsp;J</a></li>
				</ul>

				<h3 id="image-de-decoration">Image de décoration</h3>
				...
				<h3 id="image-reactive">Image réactive</h3>
				<ol>
				...
				<h3 id="information-donnee-par-la-couleur">Information (donnée par la couleur)</h3>
				...
				<h3 id="intitule-de-lien">Intitulé de lien</h3>
				...
				<h2 id="j">J</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#i">Lettre&nbsp;I</a></li>
					<li class="goafter"><a href="#l">Lettre&nbsp;L</a></li>
				</ul>

				<h3 id="taille-caracteres">Jusqu’à ou à partir de 150% (1.5em) de la taille de police par défaut sans effet de graisse. Jusqu’à ou à partir de 120% (1.2em) de la taille de police par défaut en gras</h3>
				<p>Jusqu’à ou à partir de 120% (1.2em) de la taille de police par défaut en gras</p>
				...
				<h2 id="l">L</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#j">Lettre&nbsp;J</a></li>
					<li class="goafter"><a href="#m">Lettre&nbsp;M</a></li>
				</ul>

				<h3 id="langue-par-defaut">Langue par défaut</h3>
				<p>Indication de la langue de traitement principale du document qui peut être présente sur l’élément racine <code lang="en">html</code> ou sur chaque élément de la page concerné <i>via</i> les attributs <code lang="en">lang</code> et/ou <code lang="en">xml:lang</code> selon le schéma suivant&nbsp;:</p>
				<ul>
				...
				<h3 id="nom-role-valeur-parametrage-changements-etats">Le nom, le rôle, la valeur, le paramétrage et les changements d’états</h3>
				...
				<p>Un composant peut s’appuyer sur un élément interactif HTML ou sur un élément non interactif surchargé par l’API ARIA <i>via</i> un rôle adh’oc. <strong>Important</strong>&nbsp;: les boutons (balises button ou input type="button") lorsqu’ils sont contrôlés <i>via</i> JavaScript sont à évaluer avec le <strong>critère 7.1</strong>.</p>
				...
				<p><strong>Note&nbsp;:</strong> les rôles, propriétés et états ARIA s’implémentent <i>via</i> des attributs, par exemple <code lang="en">role="banner"</code>, <code lang="en">aria-hidden="true"</code>.</p>

				<h3 id="legende-dimage">Légende d’image</h3>
				...
				<p>HTML5 propose d’associer une légende à une image <i>via</i> les éléments <code lang="en">figure</code> (l’ensemble de l’image et la légende) et <code lang="en">figcaption</code> (la légende).</p>
				...
				<h3 id="liens-evitement">Liens d’évitement ou d’accès rapide</h3>
				...
				<ul>
					<li>Liste ordonnée&nbsp;: balises <code lang="en">ol</code> et <code lang="en">li</code> (chaque élément de la liste est affecté d’un marqueur indéxé)&nbsp;;</li>
					<li>Liste non ordonnée&nbsp;: balises <code lang="en">ul</code> et <code lang="en">li</code> (chaque élément de la liste est affecté d’un marqueur non-indéxé&nbsp;;</li>
				...
				<h2 id="m">M</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#l">Lettre&nbsp;L</a></li>
					<li class="goafter"><a href="#o">Lettre&nbsp;O</a></li>
				</ul>

				<h3 id="mecanisme-de-remplacement">Mécanisme de remplacement</h3>
				...
				<h3 id="media-non-temporel">Média non temporel</h3>
				<p>Contenu qui ne se déroule pas dans le temps, consultable <i>via</i> un plugin (Flash, Java, Silverlight…) ou <i>via</i> les éléments <code lang="en">svg</code> et <code lang="en">canvas</code>&nbsp;; par exemple, une carte interactive en Flash, une application Flash ou Java, un diaporama sont des médias non temporels. Un média non temporel peut contenir des médias temporels (un lecteur Flash qui propose une liste de vidéos à consulter, par exemple).</p>
				...
				<h3 id="media-temporel">Média temporel (type son, vidéo et synchronisé)</h3>
				<ul>
				  ...
				  <ul>
				  	...
				  	<li>Contenu embarqué dans la page Web et consultable dans la page Web <i>via</i>&nbsp;:
				    <ul>
				...
				<h3 id="modification-role-natif-element-html">Modification du rôle natif d’un élément HTML</h3>
				...
				<p>Pour qu’une modification du rôle natif d’un élément HTML <i>via</i> WAI-ARIA soit compatible, il faut que les restrictions soient respectées.</p>
				<h3 id="moteur-de-recherche">Moteur de recherche (interne à un site Web)</h3>
				...
				<p>Voir la définition technique de zone d’en-tête fournie par l’API ARIA <a href="http://www.w3.org/WAI/PF/aria/roles#search"><span lang="en">search (role)</span></a>.</p>
				...
				<ul>
					...
					<li>Utiliser en remplacement d’un role ou d’une propriété WAI-ARIA mal supporté, un rôle ou une propriété WAI-ARIA équivalent, offrant un comportement et une restitution similaire.</li>
				</ul>
				...
				<h2 id="p">P</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#o">Lettre&nbsp;O</a></li>
					<li class="goafter"><a href="#r">Lettre&nbsp;R</a></li>
				</ul>
				...
				<h3 id="proprietes-methodes-dom">Propriétés et méthodes conformes à la spécification DOM</h3>
				<p>Les méthodes d’insertion de contenu conformes à la spécification DOM permettent de créer, insérer et manipuler des éléments <i>via</i> le DOM (par exemple <code lang="en">document.createElement</code> et <code lang="en">element.appendChild</code>) par opposition à la méthode <code lang="en">document.write</code> qui peut poser des problèmes dans certains contextes (voir&nbsp;: <a hreflang="en" href="https://www.w3.org/TR/html5/webappapis.html#dom-document-write">https://www.w3.org/TR/html5/webappapis.html#dom-document-write</a>).</p>

				<h2 id="r">R</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#p">Lettre&nbsp;P</a></li>
					<li class="goafter"><a href="#s">Lettre&nbsp;S</a></li>
				</ul>
				...
				<h3 id="correctement-restituee">Correctement restitué (par les technologies d’assistance)</h3>
				...
				<p>Le test consiste à vérifier que la restitution est pertinente pour au moins une des combinaisons de la <a href="base.html">base de référence</a> utilisée pour déclarer qu’un élément, un dispositif ou une alternative est "compatible avec l’accessibilité".</p>
				...
				<h3 id="resume-de-tableau">Résumé (de tableau)</h3>
				...
				<p>Parmi les 5 techniques proposées par HTML5, la seule technique utilisable actuellement est celle qui consiste à insérer le résumé directement dans le titre (balise <code lang="en">caption</code>) en masquant le résumé <i>via</i> CSS si nécessaire.</p>
				<p><a href="notes-techniques.html#crit-5-1">Consulter la note technique au sujet du résumé de tableau</a>.</p>

				<h2 id="s">S</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#r">Lettre&nbsp;R</a></li>
					<li class="goafter"><a href="#t">Lettre&nbsp;T</a></li>
				</ul>

				<h3 id="script">Script</h3>
				<p>Code généralement écrit sous forme d’une liste de commandes (par exemple JavaScript). Les langages interprétés côté client nécessitent un navigateur compatible sur lequel l’exécution du langage est active. Les commandes d’un langage de script côté client peuvent être embarquées ou contenues dans un fichier externe. Dans les deux cas, l’insertion se fait <i>via</i> la balise <code lang="en">&lt;script&gt;</code>.</p>

				<h3 id="sens-de-lecture">Sens de lecture</h3>
				<p>Indique le sens de lecture du document ou d’un passage de texte <i>via</i> l’attribut <code lang="en">dir</code>, <code lang="en">dir="ltr"</code>, par exemple. Les deux valeurs reconnues sont&nbsp;:</p>
				<ul>
				...
				<p><strong>Note</strong>&nbsp;: en l’absence d’indication de sens de lecture <i>via</i> l’attribut <code lang="en">dir</code> sur l’élément <code lang="en">html</code>, <code lang="en">body</code>, ou un des parents du texte analysé, le sens de lecture par défaut est de gauche à droite (valeur <code lang="en">ltr</code>).</p>

				<h3 id="site-web">Site Web&nbsp;: ensemble de toutes les pages Web</h3>
				<ul>
				...
				<h3 id="sous-titres-synchronises">Sous-titres synchronisés (objet multimédia)</h3>
				...
				<h2 id="t">T</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#s">Lettre&nbsp;S</a></li>
					<li class="goafter"><a href="#u">Lettre&nbsp;U</a></li>
				</ul>

				<h3 id="tableau-de-donnees">Tableau de données</h3>
				<p>Élément HTML (balise <code lang="en">table</code>) permettant de structurer des informations en lignes et en colonnes <i>via</i> des cellules de données (balise <code lang="en">td</code>) et des cellules d’en-têtes (balise <code lang="en">th</code>).</p>

				<h3 id="tableau-de-donnees-complexe">Tableau de données complexe</h3>
				...
				<h3 id="texte-style">Texte stylé</h3>
				...
				<p><strong>Note</strong>&nbsp;: les titres cachés <i>via</i> CSS sont considérés comme présents et valident le critère 9.1.</p>

				<h3 id="titre-tableau">Titre d’un tableau (de données)</h3>
				...
				<p>Contenu de l’attribut <code lang="en">title</code> de la balise <code lang="en">iframe</code> permettant de connaitre la nature du contenu diffusé <i>via</i> le cadre en ligne lorsque l’utilisateur navigue de cadre en cadre ou affiche la liste des cadres de la page par exemple.</p>
				...
				<h3 id="titre-de-page">Titre de page</h3>
				...
				<h3 id="transcription-textuelle">Transcription textuelle (média temporel)</h3>
				...
				<h3 id="type-et-format-de-donnees">Type et format de données</h3>
				...
				<h2 id="u">U</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#t">Lettre&nbsp;T</a></li>
					<li class="goafter"><a href="#v">Lettre&nbsp;V</a></li>
				</ul>

				<h3 id="uniquement-presentation">Uniquement à des fins de présentation</h3>
				...
				<h2 id="v">V</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#u">Lettre&nbsp;U</a></li>
					<li class="goafter"><a href="#z">Lettre&nbsp;Z</a></li>
				</ul>
				...
				<p>Les contenus doivent être conformes à la <a href="http://references.modernisation.gouv.fr/sites/default/files/liste-criteres-documents-bureautiques-telechargement-RGAA.odt">liste des critères Documents Bureautiques en téléchargement (format ODT, 74 kilo-octets)</a>.</p>
				...
				<h2 id="z">Z</h2>
				<ul class="skiplink">
					<li class="gobefore"><a href="#v">Lettre&nbsp;V</a></li>
					<li class="gobefore gotoc"><a href="#toc">Sommaire</a></li>
				</ul>

				<h3 id="zone-image-reactive">Zone (d’une image réactive)</h3>
