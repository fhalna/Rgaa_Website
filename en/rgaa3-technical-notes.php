...
$lang = 'en';
$pageTitle = 'Technical notes - RGAA 3 2017 (English translation) - Tanaguru';
$canonicalUrl = '/en/rgaa3-technical-notes.html';
$alternateUrls = array (
...
<main id="main" role="main">
			<div class="headrub page">
				<h1>Technical Notes - RGAA 3 2017</h1>
				<p class="lead">The technical notes below provide explanations regarding some HTML5 elements whose support can be inconsistent across different user agents, and propositions made by the <abbr lang="fr" title="Référentiel Général d'Accessibilité des Administrations">RGAA</abbr> to circumvent potential issues.</p>
				<div id="navtoc">
					...
					<nav class="nav" role="navigation" aria-labelledby="toc">
						<ul>
							...
							<li><a href="#formulaires">Forms</a></li>
			...
			<div class="page">
				...
				<h3 id="crit-1-1">Criterion 1.1 [A]</h3>
				...
				<h3 id="crit-1-2">Criterion 1.2 [A]</h3>
				...
				<h3 id="crit-1-3">Criterion 1.3 [A]</h3>
				...
				<p>The 1.3.7 and 1.3.9 tests are used to verify that the implementation of the alternative is accessibility supported (with the chosen <a href="./rgaa3-baseline.html">baseline</a>).
				</p>

				<h3 id="crit-1-6">Criterion 1.6 [A]</h3>
				<p>With SVG, the lack of support for the <code>&lt;title&gt;</code> element by assistive technologies incurs issues when the <code>&lt;desc&gt;</code> element is used to implement the  short alternative text for the image, whereas the image requires detailed description. In this case it is recommended to use an adjacent text or an adjacent link to provide the detailed description.
				</p>
				...
				<h3 id="crit-5-1">Criterion 5.1 [A]</h3>
				...
				<h3 id="crit-7-1">Alternative to JavaScript and compatibility of user interface components with assistive technologies</h3>
				...
				<h3 id="crit-7-3">Criterion 7.3 [A]</h3>
				<p>For certain user interface components design patterns, ARIA defines a set of keyboard interactions  based on <kbd>Esc</kbd>, <kbd>Spacebar</kbd>, <kbd>Tab</kbd> and arrow keys; and, occasionally, other interactions based on <kbd>Page Up</kbd>, <kbd>Page Down</kbd>, Home and End keys, for example. In order to allow gradual implementation of these components with complex keyboard interactions, the RGAA restricts the requirements to only main keys (<kbd>Esc</kbd>, <kbd>Spacebar</kbd>, <kbd>Tab</kbd>, Arrow keys) as per the <a href="./rgaa3-glossary.html#motif-de-conception">ARIA  design patterns.</a></p>

				<h2 id="structure">Information structure</h2>

				<h3 id="crit-9-1">Criterion 9.1 [A]</h3>
				...
				<h3 id="crit-9-2">Criterion 9.2 [A]</h3>
				...
				<h3 id="crit-9-3">Criterion 9.3 [A]</h3>
				...
				<p>References: <a rel="external" class="external" href="http://www.w3.org/WAI/PF/aria/roles#list">The Role Model,  List Role</a> and <a rel="external" class="external" href="http://www.w3.org/WAI/PF/aria/states_and_properties#aria-setsize">The role model - ARIA SETSIZE</a>.</p>

				<h3 id="crit-9-4">Criterion 9.4 [AAA]</h3>
				<p>Despite the existence of the <code>definition</code> role, used in combination with the <code>aria-labelledby</code> property, WAI-ARIA does not offer a role equivalent  to HTML definition lists (<code>DL</code>). The  <code>definition</code> role can not, therefore, be used as an equivalent of an HTML definition list <code>DL</code>.</p>

				<h2 id="presentation">Presentation of information</h2>

				<h3 id="crit-10-13">Criterion 10.13 [A]</h3>
				...
				<h2 id="formulaires">Forms</h2>

				<h3 id="crit-11-11">Criterion 11.11 [AA]</h3>
				...
				<p>Reference: <a rel="external" class="external" href="http://www.whatwg.org/specs/web-apps/current-work/#constraint-validation">WHATWG - 4.10.21.3 The constraint validation API</a>.
				</p>

				<h2 id="navigation">Navigation</h2>

				<h3 id="crit-12-10">Criterion 12.10 [A]</h3>
