...
$lang = 'fr';
$pageTitle = 'Glossaire - RGAA 4.0 2019 - Tanaguru';
$pageDescription = 'Glossaire du RGAA 4.0 2019, mis en page par Tanaguru. Toutes les définitions pour bien comprendre les critères.';
$canonicalUrl = '/rgaa4-glossaire.html';
$alternateUrls = array (
			...
			<div class="page">
				...
				<article id="lettre-l">
					...
					<section class="section-glossary">
						...
						<p><strong>Note 1&nbsp;:</strong> Un lien d’évitement ou d’accès rapide dont l’activation ne permettrait pas de reprendre la lecture et la navigation clavier à partir de la cible du lien lors de l’utilisation des navigateurs et des aides techniques retenus dans l’environnement de test (ou «&nbsp;base de référence&nbsp;») de l’audit serait considéré comme non conforme.</p>
						<p><strong>Note 2&nbsp;:</strong> les liens d’évitements ou d’accès rapide doivent être situés à la même place dans la présentation et dans le même ordre relatif dans le code source afin de satisfaire au <a href="/rgaa4-criteres.html#crit-12-2">critère 12.2</a>.</p>
					</section>

					<section class="section-glossary">
						<h3 id="glossaire-72"><a href="#glossaire-72">Liens identiques</a></h3>
						<p>Deux liens sont dits identiques quand le lien x (intitulé du lien seul, contenu de l’attribut <code>title</code> ou contexte du lien) est égal au lien y. Cette définition s’applique à tous les types de liens&nbsp;: lien texte, lien image (les liens ont alors la même image) et lien composite.</p>
						<p><strong>Attention&nbsp;:</strong> des liens avec des intitulés identiques mais des titres de liens différents ou des contextes de liens différents ne sont pas identiques (exemple&nbsp;: <code>&lt;a href="lien_bar.html" title="cliquer ici pour télécharger la barre d'outils"&gt;cliquer ici&lt;/a&gt;</code> et <code>&lt;a href="lien_doc.html" title="cliquer ici pour télécharger le document"&gt;cliquer ici&lt;/a&gt;</code>).</p>
					</section>
				...
				<article id="lettre-m">
					...
					<section class="section-glossary">
						...
						<p>Composant d’interface dont l’activation permet de modifier l’apparence du site ou de la page de manière à afficher les contenus avec un ratio de contraste suffisant. Le design de ce composant d’interface devra être conforme au <a href="/rgaa4-criteres.html#crit-3-2">critère 3.2</a> et au <a href="/rgaa4-criteres.html#crit-3-3">critère 3.3</a> sans avoir recours lui-même à un mécanisme permettant d’afficher un rapport de contraste conforme.</p>
					</section>
					...
					<section class="section-glossary">
						...
						<p><strong>Note 1&nbsp;:</strong> l’utilisation du paramètre wmode pour un objet Flash avec les valeurs <code>"transparent"</code> et <code>"opaque"</code> invalide de fait le <a href="/rgaa4-criteres.html#crit-4-11">critère 4.11</a>. En effet, l’utilisation de ces valeurs a pour conséquence que l’animation Flash vue du côté des utilisateurs de lecteur d’écran est invisible.</p>
				...
				<article id="lettre-p">
					...
					<section class="section-glossary">
						<h3 id="glossaire-86"><a href="#glossaire-86">Passage de texte associé au tableau de données</a></h3>
						<p>Texte dans une balise <code>&lt;caption&gt;</code> ou dans une balise associée au tableau de données via l’attribut WAI-ARIA <code>aria-labelledby</code>.</p>
					</section>
					...
					<section class="section-glossary">
						<h3 id="glossaire-88"><a href="#glossaire-88">Pertinence (information autrement que par la couleur)</a></h3>
						...
						<p><strong>Note&nbsp;:</strong> l’utilisation d’une balise d’emphase (<code>&lt;strong&gt;</code> ou <code>&lt;em&gt;</code>) comme autre moyen pour récupérer une information donnée par la couleur permet de valider le critère même si ces éléments ne sont généralement pas supportés par les technologies d’assistance, particulièrement les lecteurs d’écran.</p>
					</section>
					...
					<section class="section-glossary">
						...
						<p><strong>Note 2&nbsp;:</strong> l’indication visuelle du focus du navigateur ne doit pas être supprimée ou dégradée sauf si un style du focus défini par l’auteur est visible et suffisamment contrasté au regard du <a href="/rgaa4-criteres.html#crit-3-3">critère 3.3</a>.</p>
					</section>
				...
				<article id="lettre-r">
					...
					<section class="section-glossary">
						...
						<p>Par exemple&nbsp;: le <a href="/rgaa4-criteres.html#test-1-3-7">test 1.3.7</a> demande de vérifier que l’alternative d’une image porteuse d’information vectorielle est correctement restituée.</p>
						<p>On procède alors à un test avec NVDA (dernière version) et Firefox, JAWS (version précédente) et IE9+, et Voice Over (dernière version) et Safari.</p>
				...
				<article id="lettre-s">
					...
					<section class="section-glossary">
						<h3 id="glossaire-102"><a href="#glossaire-102">Si nécessaire (texte visible en complément de l'attribut <code>aria-label</code> ou <code>aria-labelledby</code>)</a></h3>
						<p>Les attributs WAI-ARIA <code>aria-label</code> et <code>aria-labelledby</code> peuvent être utilisées pour créer une <a href="#glossaire-40">étiquette</a> de champ de formulaire. L’<a href="#glossaire-40">étiquette</a> ainsi créée restera invisible ce qui permet de résoudre beaucoup de cas où un label visible n’est pas souhaité.</p>
						<p>En revanche cela crée un risque potentiel pour certains utilisateurs et il peut être nécessaire qu’un texte visible et accolé au champ vienne compléter le dispositif proposé par l’attribut WAI-ARIA <code>aria-label</code> ou <code>aria-labelledby</code>.</p>
					</section>
				...
				<article id="lettre-t">
					...
					<section class="section-glossary">
						...
						<p>La hiérarchie entre les titres doit être respectée dans une page web et les degrés de titre ne peuvent pas être sautés (un titre <code>&lt;h3&gt;</code> ne peut pas venir directement après un titre <code>&lt;h1&gt;</code>, par exemple). Par contre, la hiérarchie ne doit pas obligatoirement débuter par un <code>&lt;h1&gt;</code>. Même si cet usage n’est pas encouragé, il est considéré comme conforme de débuter la hiérarchie des titres d’une page par un autre niveau que le niveau 1.</p>
						<p><strong>Note&nbsp;:</strong> les titres cachés via CSS sont considérés comme présents et valident le <a href="/rgaa4-criteres.html#crit-9-1">critère 9.1</a>.</p>
					</section>
...
&lt;/div&gt;</code></pre>
					...
					<section class="section-glossary">
						<h3 id="glossaire-120"><a href="#glossaire-120">URL</a></h3>
						<p>Adresse permettant d’accéder aux ressources du <span lang="en">World Wide Web</span>&nbsp;: document HTML, Pages web, image, son…</p>
				...
				<article id="lettre-v">
					...
					<section class="section-glossary">
						...
						<p>Les contenus doivent être conformes à la <a href="http://references.modernisation.gouv.fr/sites/default/files/liste-criteres-documents-bureautiques-telechargement-RGAA.odt" rel="external" class="external">liste des critères Documents Bureautiques en téléchargement (format ODT, 74 kilo-octets)</a>.</p>
